...
/*
    ...
    Author: lq
*/
package com.lq186.algorithm.list.linked;

import com.lq186.algorithm.data.NodeData;
import com.lq186.algorithm.list.linked.data.LinkedList;
...
public final class Bootstrap {
    ...
    public static void main(String[] args) {
        LinkedList<NodeData> sequentialList = new LinkedList<>();
